...
namespace LinkOM
{
	[Activity (Label = "DocumentEditActivity", Theme = "@style/Theme.Customtheme")]			
	public class DocumentEditActivity : Activity
	{
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			SetContentView (Resource.Layout.DocumentEdit);
...
//			//Handle priority
//
//			PriorityAdapter = ArrayAdapter.CreateFromResource (this, Resource.Array.DocumentPriority, Android.Resource.Layout.SimpleSpinnerItem);
...
//
//			if(DocumentDetail.PriorityName!=""){
//				int index = PriorityAdapter.GetPosition (DocumentDetail.PriorityName);
...
//
//			var StatusAdapter = ArrayAdapter.CreateFromResource (this, Resource.Array.DocumentStatus, Android.Resource.Layout.SimpleSpinnerItem);
...
//
//			if(DocumentDetail.StatusName!=""){
//				int index = StatusAdapter.GetPosition (DocumentDetail.StatusName);
...
//
//			if(DocumentDetail.ProjectPhaseName!=""){
//				int index = PhaseAdapter.GetPosition (DocumentDetail.ProjectPhaseName);
...
//				DocumentStatusId= Selected_StatusID,
//				AllocatedHours= editText_AllocatedHours.Text,
//				IsUserWatch = cb_WatchList.Checked,
//				UpdatedBy = DocumentDetail.CreatedBy,
//			};
//
//			var objEditDocument = (new
//				{
//					objDocument = new
//					{
...
//				});
//
//			string results= ConnectWebAPI.Request(url,objEditDocument);
//
//			if (results != null) {
//				ResultsJson ResultsJson = Newtonsoft.Json.JsonConvert.DeserializeObject<ResultsJson> (results);
//
//				if (ResultsJson.Success) {
//					Toast.MakeText (this, "Document Saved", ToastLength.Short).Show ();
//				} else
