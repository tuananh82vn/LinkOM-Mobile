	...
	public class MenuListAdapter : BaseAdapter
	{
			...
			: base()
		{
			...
			this.items = new List<MenuItem>() {
				...
				new MenuItem() { Name = "Projects", 	Img = Resource.Drawable.Projects , 	Type="item" },
				new MenuItem() { Name = "Tasks", 	Img = Resource.Drawable.Tasks, 		Type="item" },
				new MenuItem() { Name = "Tickets", 	Img = Resource.Drawable.Tickets, 	Type="item" },
				new MenuItem() { Name = "Issues", 	Img = Resource.Drawable.Issues , 	Type="item"},
				new MenuItem() { Name = "Milestones", Img = Resource.Drawable.Milestones, Type="item" },
				new MenuItem() { Name = "Documents", Img = Resource.Drawable.Documents, 	Type="item" },
				new MenuItem() { Name = "Knowledgebases", Img = Resource.Drawable.book, 	Type="item" },
				new MenuItem() { Name = "SETTINGS", 	Img = Resource.Drawable.Milestones, Type="divider" },
				...
				new MenuItem() { Name = "Alert Configuration", 	Img = Resource.Drawable.alert, 	Type="item" },
